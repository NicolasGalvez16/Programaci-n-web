...
from src.anuncios.forms import FormularioEvento, FormularioRegistro
...
def detalle_evento(slug):
    ...
    return render_template("detalle.html", evento=evento, restantes=restantes)
...
def registrar_evento(slug):
    ...
    return render_template("form_registro.html", evento=evento, form=form)
...
def eventos_por_categoria(categoria):
    ...
    return render_template("por_categoria.html", categoria=categoria, eventos=filtrados, categorias=categorias)

SignupForm = FormularioRegistro
PostForm   = FormularioEvento
